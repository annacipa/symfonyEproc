...
class FormController extends AbstractController
{
    ...
    {
        if ($this->isCsrfTokenValidisCsrfTokenValid('delete'.$form->getId(), $request->request->get('_token'))) {
            var_dump(isCsrfTokenValidisCsrfTokenValid('delete'.$form->getId(), $request->request->get('_token')));
            $entityManager = $this->getDoctrine()->getManager();
